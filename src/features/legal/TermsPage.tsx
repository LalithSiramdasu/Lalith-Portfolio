...
const TermsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms & Conditions | Lalith Kumar</title>
        <meta name="description" content="Terms and conditions for Siramdasu Lalith Kumar's portfolio website." />
      </Helmet>
      <div className="home-container relative min-h-full py-12 px-4 md:px-8 max-w-5xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed">
          <section className="mb-6">
            ...
            <p className="mb-4">
              Welcome to the personal portfolio website of Siramdasu Lalith Kumar (the "Website").
          ...
          <section className="mb-10">
            ...
            <p className="text-sm text-gray-500 text-center mt-8 border-t border-gray-200 pt-6">
              These Terms and Conditions constitute a legally binding agreement between you and Siramdasu Lalith Kumar.

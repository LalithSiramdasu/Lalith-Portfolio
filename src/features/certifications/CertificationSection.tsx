...
export const CertificationSection = () => {
    useFavicon('certifications');

    return (
        <>
            <Helmet>
                <title>Certifications | Lalith Kumar</title>
                <meta name="description" content="Industry certifications of Siramdasu Lalith Kumar including AWS, Oracle OCI, Infosys Springboard, and TensorFlow learning credentials." />
            </Helmet>
            <div className="home-container relative py-12 px-4 max-w-7xl mx-auto min-h-full">
                ...
                <header className="text-center space-y-8 mb-16 animate-fade-in px-4">
                    ...
                    <p className="text-gray-500 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-medium">
                        Certifications that reinforce my foundation in cloud, Java, and modern AI tooling.
                    </p>
                </header>

...
export const SOCIAL_LINKS = [
    { icon: Github, label: "GitHub", href: "https://github.com/LalithSiramdasu", category: "social" },
    { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/lalith-siramdasu", category: "social" },
];

...
export const AboutPage = () => {
  useFavicon('about');
  const stats = [
    { label: "Projects", value: "4", icon: <Zap className="w-4 h-4" />, color: "blue" },
    { label: "Publication", value: "1", icon: <Layers className="w-4 h-4" />, color: "amber" },
    { label: "CGPA", value: "8.87", icon: <Binary className="w-4 h-4" />, color: "emerald" },
  ];

  return (
    <div className="home-container relative py-12 px-4 max-w-6xl mx-auto min-h-full overflow-visible">
      <Helmet>
        <title>About Lalith Kumar | AI & Machine Learning Engineer</title>
        <meta name="description" content="Learn about Siramdasu Lalith Kumar's journey as an AI and machine learning engineer working on deep learning, NLP, computer vision, and full-stack systems." />
      </Helmet>
      ...
      <header className="relative z-10 mb-20 animate-fade-in">
        ...
        <p className="text-xl md:text-2xl text-gray-500 font-medium max-w-3xl leading-relaxed">
          I am Siramdasu Lalith Kumar - an AI and machine learning student-engineer focused on building intelligent systems that solve real problems.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 relative z-10">
        ...
        <div className="md:col-span-8 p-10 rounded-[3rem] bg-white border border-gray-100 shadow-2xl shadow-gray-200/50 flex flex-col justify-between group hover:border-blue-200/50 hover:-translate-y-2 transition-all duration-700">
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-600 font-medium text-lg leading-relaxed max-w-2xl">
              <p>
                I am pursuing B.Tech in <span className="text-gray-900 font-bold">Artificial Intelligence and Machine Learning at VIT-AP</span>, where I have built a strong foundation in ML, deep learning, computer vision, and applied software engineering.
              </p>
              <p>
                My work spans <span className="text-blue-600 font-bold">multi-modal AI, deep learning, NLP, and full-stack development</span> - from agricultural assistants and healthcare prediction systems to reinforcement learning agents and CNN-powered crop disease detection.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-4 p-10 rounded-[3rem] bg-white border border-gray-100 shadow-xl shadow-gray-200/40 flex flex-col justify-between overflow-hidden relative group hover:border-blue-200/50 hover:-translate-y-2 transition-all duration-500">
          ...
          <h3 className="text-xs font-black uppercase tracking-widest text-blue-600 mb-8 flex items-center gap-3">
            Snapshot <div className="h-px flex-1 bg-gray-100" />
          </h3>
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              <div className="w-1.5 h-10 rounded-full bg-blue-500" />
              <div>
                <p className="text-xl font-black tracking-tight text-gray-900">AI Master Gardener</p>
                <p className="text-sm font-bold text-gray-500">Multi-modal AI platform</p>
                <p className="text-[10px] font-medium text-gray-400 uppercase tracking-wide">Computer vision + LLMs</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-1.5 h-10 rounded-full bg-orange-500" />
              <div>
                <p className="text-xl font-black tracking-tight text-gray-900">Healthcare ML</p>
                <p className="text-sm font-bold text-gray-500">85% diagnostic accuracy</p>
                <p className="text-[10px] font-medium text-gray-400 uppercase tracking-wide">4-model evaluation pipeline</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] font-medium text-gray-400 uppercase tracking-wide">Embedded systems journal paper</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-8 p-10 rounded-[3rem] bg-gray-50/50 backdrop-blur-xl border border-gray-100 flex flex-col justify-between relative overflow-hidden group hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-500 font-medium leading-relaxed max-w-xl">
              Building intelligent systems with TensorFlow, Keras, OpenCV, Ollama, Supabase, React, Node.js, and Flask across ML, NLP, and AI-driven product workflows.
            </p>
          </div>
          <div className="flex flex-wrap gap-3 mt-8">
            {["TensorFlow", "Keras", "OpenCV", "Scikit-learn", "React", "Node.js", "Flask", "Supabase", "AWS"].map((tool, i) => (

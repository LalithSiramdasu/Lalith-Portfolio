...
export const EducationSection = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Education | Lalith Kumar</title>
                <meta name="description" content="Academic background of Siramdasu Lalith Kumar - B.Tech in Artificial Intelligence and Machine Learning from VIT-AP with 8.87 CGPA." />
            </Helmet>
            <div className="home-container relative py-12 px-4 max-w-7xl mx-auto min-h-full">
                ...
                <header className="text-center space-y-8 mb-20 animate-fade-in px-4">
                    ...
                    <p className="text-gray-500 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-medium">
                        The academic foundation behind my AI, machine learning, and intelligent systems work.
                    </p>
                </header>

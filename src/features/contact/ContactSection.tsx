...
export const ContactSection = () => {
    ...
    const stats = [
        { label: "Academic Record", value: "8.87", rating: "VIT-AP CGPA", href: "/education", color: "blue" },
        { label: "LeetCode", value: "DSA", rating: "Problem Solving", href: "https://leetcode.com/u/Lalith555/", color: "indigo" },
        { label: "Certifications", value: "4", rating: "Cloud + AI", href: "/certifications", color: "emerald" },
    ];

    const socials = [
        { icon: <Github className="w-5 h-5" />, label: "GitHub", href: "https://github.com/LalithSiramdasu", color: "blue" },
        { icon: <Linkedin className="w-5 h-5" />, label: "LinkedIn", href: "https://www.linkedin.com/in/lalith-siramdasu", color: "blue" },
        { icon: <Code2 className="w-5 h-5" />, label: "LeetCode", href: "https://leetcode.com/u/Lalith555/", color: "indigo" },
    ];
        ...
        <div className="home-container relative py-12 px-4 max-w-7xl mx-auto min-h-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 relative z-10">
                        ...
                        <div className="space-y-6 md:space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-blue-100 text-base md:text-xl font-medium max-w-sm md:max-w-xl leading-relaxed">
                                    Zero logs. Zero traces. Your signal reaches me through an encrypted void pure, unfiltered communication.
                                </p>
                            </div>
                        </div>

                        <div className="flex flex-wrap items-center gap-4 font-black uppercase tracking-widest text-[10px] md:text-xs">
                            <span className="px-5 py-2 rounded-full bg-white text-blue-600 shadow-lg shadow-black/5">Launch Signal</span>
                            <span className="text-blue-200">Ghost Mode</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-4 grid grid-cols-1 gap-4 md:gap-6">
                    <a
                        href="mailto:lalithkumarsiramdasu@gmail.com"
                    ...
                    >
                        ...
                        <div className="space-y-1 min-w-0">
                            ...
                            <p className="text-xs sm:text-sm md:text-lg font-extrabold text-gray-900 group-hover:text-blue-600 transition-colors">lalithkumarsiramdasu@gmail.com</p>
                        </div>
                    </a>

                    <a
                        href="tel:+919392737578"
                    ...
                    >
                        ...
                        <div className="space-y-1 min-w-0">
                            ...
                            <p className="text-sm sm:text-base md:text-xl font-extrabold text-gray-900 group-hover:text-indigo-600 transition-colors break-words">+91 9392737578</p>
                        </div>
                    </a>
                    ...
                    <div className="group flex items-center gap-4 md:gap-6 p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-white border border-gray-100 shadow-xl shadow-gray-200/30 hover:border-blue-200/50 transition-all">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-base md:text-xl font-extrabold text-gray-900 group-hover:text-blue-600 transition-colors">Andhra Pradesh, India</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-8 bg-white border border-gray-100 rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-14 shadow-xl shadow-gray-200/30 overflow-hidden relative">
                    <div className="flex items-center gap-5 mb-10 md:mb-16">
                        ...
                        <div>
                            <h3 className="text-[10px] md:text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em]">Professional Snapshot</h3>
                            <p className="text-2xl md:text-4xl font-black text-gray-900 tracking-tight">Core Highlights</p>
                        </div>
                    </div>
